                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('dashboards.edit', $pengaduan->id) }}" class="text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                            <form action="{{ route('dashboards.destroy', $pengaduan->id) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('DELETE')
